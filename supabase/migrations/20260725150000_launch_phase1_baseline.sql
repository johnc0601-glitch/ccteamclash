...
insert into public.launch_teams (
  id,
  name,
  short_name,
  logo,
...
create index if not exists launch_event_rosters_submitted_by_profile_id_idx
on public.launch_event_rosters(submitted_by_profile_id);
create index if not exists launch_event_roster_players_roster_id_idx
on public.launch_event_roster_players(event_roster_id);
create index if not exists launch_event_roster_players_player_id_idx
on public.launch_event_roster_players(player_id);

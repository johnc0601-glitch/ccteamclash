...
export function MatchHero({matchday}: {matchday: PublicMatchday}) {
  ...
  return (
    <section className={styles.matchHero} data-matchday-hero data-lifecycle={matchday.lifecycle}>
      ...
      <div className={`${styles.heroMeta} matchday-hero-meta`}>
        ...
        <strong className={styles.lifecycle}>{matchday.lifecycle === 'Completed' ? 'Final' : matchday.lifecycle}</strong>
      </div>
    </section>
  );
}

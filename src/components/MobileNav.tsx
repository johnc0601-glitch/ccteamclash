      ...
      <nav>
        ...
        <div className="mobile-nav-group">
          ...
          <div style={{padding: '10px 8px'}}>
            <a href={FACEBOOK_GROUP_URL} target="_blank" rel="noreferrer" aria-label="Team Clash Facebook group" title="Facebook group" onClick={closeMenu} style={{display:'inline-flex',alignItems:'center',justifyContent:'center',lineHeight:0}}>
              <svg width={22} height={22} viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="12" fill="#1877F2" /><path fill="#fff" d="M13.7 8.3V6.9c0-.7.5-.9.9-.9h2.3V2.2L13.7 2C10.5 2 9.4 3.9 9.4 6.5v1.8H7v4.2h2.4V22h4.3v-9.5h3.1l.5-4.2h-3.6z" /></svg>
            </a>
          </div>
        </div>
      </nav>

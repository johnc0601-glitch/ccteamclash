...
function formatOpponentPlayers(entry: PlayerProfileMatchHistoryItem): string {
  if (entry.opponentPlayerNames.length) return entry.opponentPlayerNames.join(' / ');
  return entry.opponentTeamName ?? 'Opponent';
}

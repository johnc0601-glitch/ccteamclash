...
import type {Course, CourseFieldErrors, CourseInput, CourseStatusFilter} from '@/domain/course/Course';
            ...
            <tbody>
              {courses.map((course) => (
                <tr key={course.id}>
                  ...
                  <td><div className={styles.links}><a href={course.mapUrl} target="_blank" rel="noreferrer">Directions</a>{course.udiscUrl ? <a href={course.udiscUrl} target="_blank" rel="noreferrer">UDisc</a> : null}</div></td>

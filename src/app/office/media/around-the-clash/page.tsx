      ...
      <section style={{display: 'grid', gap: 18}}>
        <header style={{display: 'flex', gap: 12, alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap'}}>
          <div>
            ...
            <p style={{marginBottom: 0}}>Commissioner stats desk for finding the results worth talking about after Matchday.</p>
          </div>
        ...
        <div style={{border: '1px solid rgba(127,127,127,.35)', borderRadius: 10, padding: 12, fontSize: 13}}>
          <strong>Safe preview mode.</strong> The rows below are clearly labeled fixtures for testing navigation and story selection. They are not league records and nothing here writes to the database.
        </div>

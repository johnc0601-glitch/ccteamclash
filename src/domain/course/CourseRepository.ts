...
const COURSE_MOCK_DATA = [
  {
    ...
    udiscUrl: 'https://udisc.com/courses/the-beast-on-honey-hill-X1Pc',
    photoUrl: '',
  ...
  },
  {
    ...
    udiscUrl: 'https://udisc.com/courses/castle-hayne-park-Jkk8',
    photoUrl: '',
    description: 'League course details and current layout information are maintained on UDisc.',
    active: true,
    createdAt: '2026-01-01T00:00:00.000Z',
  ...
  },
  {
    ...
    udiscUrl: 'https://udisc.com/courses/cougar-country-7ZvT',
    photoUrl: '',
    description: 'League course details and current layout information are maintained on UDisc.',
  ...
  },
  {
    ...
    udiscUrl: 'https://udisc.com/courses/joe-eakes-park-RSG1',
    photoUrl: '',
    description: 'League course details and current layout information are maintained on UDisc.',
    homeTeamId: 'kb',
    active: true,
  ...
  },
  {
    ...
    udiscUrl: 'https://udisc.com/courses/northeast-creek-park-UIAe',
    photoUrl: '',
    description: 'League course details and current layout information are maintained on UDisc.',
    active: true,
    createdAt: '2026-01-01T00:00:00.000Z',
  ...
  },
  {
    ...
    udiscUrl: 'https://app.udisc.com/courses/splinter-city-dgc-mXj6',
    photoUrl: '',
    description: 'League course details and current layout information are maintained on UDisc.',
    active: true,
    createdAt: '2026-01-01T00:00:00.000Z',
  ...
  },
  {
    ...
    udiscUrl: 'https://udisc.com/courses/wild-turkey-disc-course-75Jd',
    photoUrl: '',
    description: 'League course details and current layout information are maintained on UDisc.',
